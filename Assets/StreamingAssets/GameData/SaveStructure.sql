...
-- Table: PlanetFaction
CREATE TABLE PlanetFaction (PlanetId INTEGER REFERENCES Planet (Id) NOT NULL, FactionId INTEGER NOT NULL, IsPublic BOOLEAN NOT NULL, Population BIGINT NOT NULL, PDFMembers INTEGER NOT NULL, PlayerReputation REAL NOT NULL, CharacterId INTEGER REFERENCES Character (Id));
