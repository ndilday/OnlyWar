--
-- File generated with SQLiteStudio v3.2.1 on Thu Oct 8 18:19:39 2020
--
...
-- Table: HitLocation
CREATE TABLE HitLocation (Id INTEGER PRIMARY KEY UNIQUE NOT NULL, SoldierId INTEGER NOT NULL REFERENCES Soldier (Id), HitLocationTemplateId INTEGER NOT NULL, WoundTotal INTEGER NOT NULL, WeeksOfHealing INTEGER);
...
CREATE TABLE PlayerSoldierFactionCasualtyCount (Id INTEGER PRIMARY KEY UNIQUE NOT NULL, PlayerSoldierId INTEGER NOT NULL REFERENCES PlayerSoldier (SoldierId), FactionId INTEGER NOT NULL, Count INTEGER NOT NULL);

-- Table: PlayerSoldierHistory
CREATE TABLE PlayerSoldierHistory (Id INTEGER PRIMARY KEY UNIQUE NOT NULL, PlayerSoldierId INTEGER NOT NULL REFERENCES PlayerSoldier, Entry STRING NOT NULL);

-- Table: PlayerSoldierWeaponCasualtyCount
CREATE TABLE PlayerSoldierWeaponCasualtyCount (Id INTEGER PRIMARY KEY UNIQUE NOT NULL, PlayerSoldierId REFERENCES PlayerSoldier (SoldierId) NOT NULL, RangedWeaponTemplateId INTEGER, MeleeWeaponTemplateId INTEGER, Count INTEGER NOT NULL);

-- Table: Ship
CREATE TABLE Ship (Id INTEGER PRIMARY KEY UNIQUE NOT NULL, ShipTemplateId INTEGER UNIQUE NOT NULL, FleetId INTEGER REFERENCES Fleet (Id) NOT NULL, Name STRING NOT NULL);
...
-- Table: SoldierSkill
CREATE TABLE SoldierSkill (Id INTEGER PRIMARY KEY UNIQUE NOT NULL, SoldierId INTEGER NOT NULL REFERENCES Soldiers (Id), BaseSkillId INTEGER NOT NULL, PointsInvested REAL NOT NULL);
